	...
	return (
		<div className="border-b border-gray-200 py-6">
			<div className="container sm:flex justify-between items-center">
				<div className="font-bold text-4xl text-center pb-4 sm:pb-0 text-blackish font-serif">D O Y R</div>
				{/* <Image src="/doyr-logo.png" alt="doyr-logo" width={100} height={100} /> */}
